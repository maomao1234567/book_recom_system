...
def search_page(request):
    ...
    # 相当于数据库的模糊查询
    post_list =models.Book6.objects.filter(serial_name__icontains=p)
...
def wordcloud():
    ...
    name = [
            '带一本书去巴黎', '变形记', '阿狸·梦之城堡', '平凡的世界（全三部）',
            '苏菲的世界', '送你一颗子弹', '天才在左 疯子在右', '嫌疑人X的献身',
            '人生', '陆犯焉识', '雷雨', '你今天真好看', '爱的艺术', '撒哈拉的故事',
            '笑傲江湖（全四册）', '第一炉香', '不能承受的生命之轻', '飘',
            '天龙八部', '三体Ⅱ']
    value1 = [
